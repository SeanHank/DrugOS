...
- **G4 rule:** every new model feature must add a validation case before merge; `python validation/run_validation.py` (45/45 cases green, see `validation/report.md`) regenerates the report and fails the gate on any red case.
