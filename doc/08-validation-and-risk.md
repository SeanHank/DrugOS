...
| Stage 4 organ | Published organ-function trajectories (e.g., DILI case studies) | qualitative + alert-level match — implemented: liver DILI dose-response (therapeutic safe vs overdose Hy's Law), dofetilide Delta-QTc vs published band, KDIGO GFR/AKI escalation |
